...
- [x] Honest benchmark vs. `llama.cpp` CPU NEON on Apple Silicon — *`asmllm` loses at 1T (382.78 t/s vs 1595.02 t/s, 4.1x slower) and 2T (386.34 t/s vs 1333.29 t/s, 3.4x slower). 4T/8T data unreliable due to virtualized runner oversubscription. Logged in `bench/results/2026-07-27-arm64-neon/raw_bench.log` and `BENCHMARKS.md`.*
