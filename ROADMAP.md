...
- [x] Honest benchmark vs. `llama.cpp` CPU NEON on Apple Silicon — *`asmllm` loses at 1T (233.75 t/s vs 1558.41 t/s, 6.7x slower) and 2T (221.27 t/s vs 2008.92 t/s, 9.1x slower). 4T/8T data unreliable due to virtualized runner oversubscription. Logged in `bench/results/2026-07-27-arm64-neon/raw_bench.log` and `BENCHMARKS.md`.*
