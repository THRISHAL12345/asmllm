...
| 2026-07-10 | `matmul_q4_neon` / `matmul_q4_mt` (Multi-Threaded ARM64 NEON Q4_0 Matvec, M=4096, K=4096) | ARM64 NEON / Apple Silicon (`Darwin 23.6.0 arm64`, macOS 14) | 1, 2, 4, 8 thread scaling & zero-intrinsics NEON assembly | **1T:** 5.473 ms (**6.13 GFLOPS**)<br>**2T:** 2.810 ms (**11.94 GFLOPS**, 1.95x)<br>**4T:** 2.840 ms (**11.81 GFLOPS**, 1.93x)<br>**8T:** 2.087 ms (**16.08 GFLOPS**, 2.62x) | Verified / `bench/results/2026-07-10-arm64-neon/raw_bench.log` | M5 Definition of Done: Hand-written ARM64 NEON assembly kernel (`src/kernels/arm64/matmul_q4_neon.S`) adhering to AAPCS64 ABI with PC-relative load literals and zero C/C++ or intrinsics in hot paths. |
